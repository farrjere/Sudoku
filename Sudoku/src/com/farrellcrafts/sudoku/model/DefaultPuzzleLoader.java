...
public class DefaultPuzzleLoader implements PuzzleLoader {
	
	private static Map<Integer, SudokuPuzzle> puzzles = loadPuzzles();
	
	@Override
	public Map<Integer, SudokuPuzzle> getPuzzles() {
		return new HashMap<Integer, SudokuPuzzle>(puzzles);
	}
	 ...
	 * @return
	 */
	private static Map<Integer, SudokuPuzzle> loadPuzzles(){
